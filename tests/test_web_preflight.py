...
from offercatch.web.preflight import check_ai_connection, check_browser_connection
...
class AiPreflightTests(unittest.TestCase):
	...
	@patch("offercatch.web.preflight.httpx.get")
...
class BrowserPreflightTests(unittest.TestCase):
	@patch("offercatch.web.preflight.run_browser_diagnostics")
