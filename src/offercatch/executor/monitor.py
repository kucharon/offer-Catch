...
from offercatch.ai.credentials import call_anthropic_text
from offercatch.browser import new_tab, close_tab, evaluate, click, wait_for_load, get_page_info
from offercatch.cancellation import (
    OperationCancelled,
    get_stop_event,
    run_cancellable,
    stop_requested,
...
from offercatch.throttle import RequestThrottle, SendWindowChecker
...
def _handle_conversation(job: dict, config: dict, conversation: dict | None = None) -> str:
    ...
    if _detect_resume_request(messages):
        ...
        from offercatch.ai.resume import generate_tailored_resume, get_last_resume_failure_reason
