"""Browser facade backed by OfferCatch's built-in Browser Runtime."""
...
from offercatch.browser.client import RuntimeClient
from offercatch.browser.runtime import ensure_runtime, get_runtime_url, set_browser_config
