...
from offercatch.browser import close_tab, new_tab, print_pdf
from offercatch.cancellation import OperationCancelled, run_cancellable, stop_requested
from offercatch.db import get_db

console = Console()

RESUME_COMPLETION_MARKER = "<!-- OFFERCATCH_RESUME_DONE -->"
...
def _render_pdf_via_cdp(html_content: str, output_path: Path) -> bool:
    ...
    temp_html = Path(tempfile.gettempdir()) / "offercatch_resume.html"
